...
void OCR::on_detect_letters_button_clicked()
{
...
void OCR::on_add_word_to_dictionary_button_clicked()
{
    printf("Javid Chaji");
}


void OCR::crop(int numsampeles, char harf[100], char saveq[100])
{
    char p[100];
    int width, height;
    int j, i, g;
...
void OCR::scale(int numsampeles, char harf[100], char saveq[100])
{
    char p[100];
...
void OCR::learning(int numsampeles, char harf)
{
    char p[100];
    int width, height;
    int i, j, k;
...
char OCR::detected_letters(char p[100])
{
    char find = '=';
...
void OCR::similarity(char harf, char *find, int *maxtatbigh)
{
...
void OCR::read_table(int *radif, int *soton, int *width, int *height)
{
...
int OCR::strstr1(char a[], char b[], int *y, int *g)
{
