#############################################################################
# Makefile for building: Final\ Project
# Generated by qmake (3.1) (Qt 5.15.5)
# Project:  Final Project.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Final\ Project.pro
#############################################################################
...
DISTDIR = /mnt/USB2/Drive\ D/University/Computer/Term\ 1/C/Project/Final\ Project/.tmp/Final\ Project1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Final Project.pro ocr.h main.cpp \
		ocr.cpp
...
Final\ Project: ui_ocr.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Final\ Project.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ocr.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp ocr.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ocr.ui $(DISTDIR)/
...
moc_ocr.cpp: ocr.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include '/mnt/USB2/Drive D/University/Computer/Term 1/C/Project/Final Project/moc_predefs.h' -I/usr/lib/qt/mkspecs/linux-g++ -I'/mnt/USB2/Drive D/University/Computer/Term 1/C/Project/Final Project' -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/12.1.0 -I/usr/include/c++/12.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/12.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include-fixed -I/usr/include ocr.h -o moc_ocr.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_ocr.h
compiler_uic_clean:
	-$(DEL_FILE) ui_ocr.h
ui_ocr.h: ocr.ui \
		/usr/bin/uic
	/usr/bin/uic ocr.ui -o ui_ocr.h
...
main.o: main.cpp ocr.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

ocr.o: ocr.cpp ocr.h \
		ui_ocr.h \
		bmpio/include/bmpio.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Final\ Project/bin || mkdir -p $(INSTALL_ROOT)/opt/Final\ Project/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Final\ Project/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Final\ Project/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Final\ Project/bin/ 
